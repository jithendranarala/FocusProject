...
public class DriverHelper {
	...
	public static void highlightObject(WebDriver driver, WebElement webElement)
		throws InterruptedException {
	JavascriptExecutor jsExecutor = (JavascriptExecutor) driver;
	for (int count = 1; count <= 1; count++) {
		jsExecutor.executeScript(
				"arguments[0].style.border='4px groove red'", webElement);
		Thread.sleep(1000);
		jsExecutor
				.executeScript("arguments[0].style.border=''", webElement);
		}
	}

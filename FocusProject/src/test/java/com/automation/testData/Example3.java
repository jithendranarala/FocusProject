...
/* This example show how to read data from xls or xlsx file */
public class Example3 {
	...
	public void readTestData() {
		...
		Sheet sheet = null;
		Row row = null;
		String testDataFile = ApplicationConstants.testDataPathXlsx;
		try {
			if(testDataFile.endsWith(".xlsx")){
				workBook = new XSSFWorkbook(new FileInputStream(ApplicationConstants.testDataPathXlsx));
